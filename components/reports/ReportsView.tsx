    ...
    const handleDownloadWord = async () => {
        ...
        const htmlContent = `
            ...
            <body style="font-family: Arial, sans-serif;">
                ...
                ${contentTable}
                <div style="margin-top: 20px; font-size: 8pt; text-align: right; color: #555;">Generated by Computerized Legislative System</div>
            </body>
            </html>
        `;
    ...
    const handleDownloadPDF = async () => {
        try {
            ...
            (doc as any).autoTable({ head: [tableColumn], body: tableRows, startY: startY, theme: 'grid', headStyles: { fillColor: [30, 58, 138] }, styles: { fontSize: 8 }, didDrawPage: function (data: any) {
                ...
                doc.text("Generated by Computerized Legislative System", doc.internal.pageSize.width - data.settings.margin.right, doc.internal.pageSize.height - 8, { align: 'right' });
            }});
