        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-grow">
                    ...
                    <h3 className="text-base font-bold text-brand-primary mb-2">{ordinance.ordinanceTitle}</h3>
                    <p className="text-xs text-slate-700 mb-3 line-clamp-2">{ordinance.fullText}</p>
