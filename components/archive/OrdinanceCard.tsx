...
const OrdinanceCard: React.FC<OrdinanceCardProps> = ({ ordinance, onEdit, onDelete, canDelete }) => {
    return (
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-grow">
                    <div className="flex items-center flex-wrap gap-4 mb-2">
                        ...
                        <p className="text-sm text-slate-500">Approved: {ordinance.dateApproved}</p>
                    </div>
                    <h3 className="text-lg font-bold text-brand-primary mb-2">{ordinance.ordinanceTitle}</h3>
                    <p className="text-sm text-slate-700 mb-3 line-clamp-2">{ordinance.fullText}</p>
