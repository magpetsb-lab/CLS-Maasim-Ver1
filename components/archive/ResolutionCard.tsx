        ...
        <div className="bg-white rounded-lg shadow-md p-4">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-2">
                <div className="flex-grow">
                    ...
                    <h3 className="text-lg font-bold text-brand-primary mb-1 leading-tight">{resolution.resolutionTitle}</h3>
                    <div className="text-sm text-slate-600 flex flex-wrap gap-x-3 gap-y-0.5 mt-1">
                ...
                <div className="flex-shrink-0 flex flex-col items-end space-y-1 mt-2 sm:mt-0 self-start sm:self-center">
                    {/* Legacy File Path */}
                    {resolution.filePath && !resolution.attachments?.length && (
                        <a
                            href="#"
                            onClick={(e) => handleViewAttachment(e, resolution.filePath!)}
