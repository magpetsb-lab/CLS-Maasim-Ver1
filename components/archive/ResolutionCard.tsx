            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-grow">
                    <div className="flex items-center flex-wrap gap-4 mb-2">
                        ...
                        <p className="text-sm text-slate-500">Approved: {resolution.dateApproved}</p>
                    </div>
                    <h3 className="text-lg font-bold text-brand-primary mb-2">{resolution.resolutionTitle}</h3>
                    <div className="text-sm text-slate-600 flex flex-wrap gap-x-4 gap-y-1 mt-3">
