            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-grow">
                    <div className="flex items-center gap-4 mb-2">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${roleColor} capitalize`}>
                           {userAccount.role}
                        </span>
                    ...
                    <h3 className="text-lg font-bold text-brand-primary">{userAccount.name}</h3>
                    <p className="text-sm text-brand-secondary font-medium mb-1">{userAccount.position}</p>
                    <p className="text-sm text-slate-600">ID: <span className="font-mono font-semibold">{userAccount.userId}</span></p>
                    <p className="text-sm text-slate-600">{userAccount.email}</p>
                </div>
                {canEdit && (
