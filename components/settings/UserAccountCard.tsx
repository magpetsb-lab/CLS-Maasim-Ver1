            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-2">
                <div className="flex-grow">
                    <div className="flex items-center gap-2 mb-1">
                        <span className={`px-2 py-0.5 text-[10px] font-semibold rounded-full ${roleColor} capitalize`}>
                           {userAccount.role}
                        </span>
                    ...
                    <h3 className="text-sm font-bold text-brand-primary leading-tight">{userAccount.name}</h3>
                    <p className="text-[10px] text-brand-secondary font-medium mb-0.5">{userAccount.position}</p>
                    <p className="text-[10px] text-slate-600">ID: <span className="font-mono font-semibold">{userAccount.userId}</span></p>
                    <p className="text-[10px] text-slate-600">{userAccount.email}</p>
                </div>
                {canEdit && (
